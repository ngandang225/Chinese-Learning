...
import './TrueFalse3.scss';
import { useState } from 'react';
import Audio from '../../../components/Audio/Audio';
import StyledButton from '../../../components/StyledButton/StyledButton';

function TrueFalse3({ ex }) {
              ...
              return (
                <tbody key={question.id}>
                  <tr className="question">
                    ...
                    <td className="clause">{question.content.split('::')[0]}</td>
                    <td className="content">{question.content.split('::')[1]}</td>
                    <td className="box-wrapper">
                      ...
                      >
                        <Box
                          className={`true-box ${selectedAnswers.some(
                        ...
                        />
                        <Box
                          className={`false-box ${selectedAnswers.some(
                    ...
                    <td
                      className={`answer ${failedAnswer.some((answer) => answer.id === question.id) ? 'false' : ''
                        }`}
                    >
                      ✘
                    </td>
